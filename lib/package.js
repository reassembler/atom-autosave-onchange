...
class Package {
    ...
    trigger(editor) {
        ...
        if (atom.config.get("daves-autosave-onchange.showNotification") === true) {
        this.notify(editor);
        }
    }
    ...
    notify(editor) {
        ...
        setTimeout (function() {note1.dismiss()}, atom.config.get("daves-autosave-onchange.notificationLength"));
    }    
}
